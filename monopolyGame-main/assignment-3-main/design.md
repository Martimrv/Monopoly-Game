...
### ComputerPlayer
Represents a Computer Player which user UI to start the actions. It implements Player class but should extends HumanPlayer class. 
Has methods in order to mover through the different tiles, rolls the dices, buy properties, paying rent or adding funds.  
